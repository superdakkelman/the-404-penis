...
class cleanup1 : ComponentActivity() {
...
@Composable
fun cleanup1Screen(modifier: Modifier = Modifier) {
    AndroidView(
        modifier = Modifier.fillMaxSize(),
        factory = { context ->
            // Inflate the XML layout
            val view = LayoutInflater.from(context).inflate(R.layout.activity_cleanup1, null, false)
